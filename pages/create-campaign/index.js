...
const CreateCampaign = () => {
    ...
    return (
        <div className='flex flex-col justify-between py-10 px-10 h-[100vh]'>
            ...
            <div className="animate__animated animate__fadeInUp animate__faster bg-white rounded-t-md fixed z-10 w-full md:w-7/12 lg:w-5/12 max-w-[600px] h-[85%] top-[15%] left-0 right-0 mx-auto">
            <div
              className="transition-all duration-300 flex flex-row justify-between relative -top-20 px-5"
            >
              <div
              ...
              >
                <FaAngleLeft className="text-xl" /> <span>back</span>
              </div>
            </div>
                <div>
