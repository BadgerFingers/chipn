    ...
    <div className="container mx-auto h-[100vh]">
      <div className="flex flex-col justify-between py-4 md:py-40 px-10 h-[100vh]">
        <div>
          <Image
            ...
            priority
          />
          { !isCreateAccount && !isLogin && !showDashboard &&
            <h1 className="text-center text-white text-xl font-medium mt-4">Hassle-free crowdfunding for friends and family</h1>
          }
        </div>
        ...
        <div className="w-full md:w-3/12 mx-auto mb-14">
          ...
          <div className="p-3 rounded-full text-center bg-grey-light bg-opacity-30 text-slate-500 cursor-not-allowed">
      ...
      {isCreateAccount && (
        <CreateAccount
          ...
          app={app}
          auth={auth}
          active={isCreateAccount}
          closeCreateAcc={() => setIsCreateAccount(false)}
      ...
      {isLogin && (
        <Login
          ...
          app={app}
          active={isLogin}
          closeLogin={() => setIsLogin(false)}
          success={() => loginSuccessHandler()}
        />
      )}
      {showDashboard && !isCreateAccount && (
        <Dashboard
          db={db}
          config={cfg}
